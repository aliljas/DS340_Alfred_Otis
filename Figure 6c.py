...
ax1.set_xticklabels(('-80', '-40', '0', '40', '80'), color='#000000')

ax1.set_yticks([0, 0.010, 0.020, 0.030], minor=False)
ax1.set_yticklabels([0, 1, 2, 3], color='#000000')
...
ax1.set_xlabel('Difference (%)', fontweight='bold', labelpad=4, color='#000000')
ax1.set_ylabel('Probability Density ' + r'$(10^{-2})$', fontweight='bold', labelpad=4, color='#000000')
...
result_name = output_directory + r'/PostCOVID_PDF.jpg'
print(result_name)
